...
namespace GameFramework.Procedure
{
    ...
    /// 流程管理器。
    /// </summary>
    internal sealed class ProcedureManager : Module, IProcedureManager
    {
        private IFsmManager _fsmModule;
        ...
        public void Initialize(IFsmManager fsmModule, params ProcedureBase[] procedures)
        {
            if (fsmModule == null)
            {
