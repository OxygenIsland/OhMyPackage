    ...
    public static partial class Utility
    {
        ...
        public static class Converter
        {
            ...
            public static float GetCentimetersFromPixels(float pixels)
            {
                if (ScreenDpi <= 0)
                {
                    throw new OhMyPackageException("You must set screen DPI first.");
                }
            ...
            public static byte[] GetBytes(string value, Encoding encoding)
            {
                if (value == null)
                {
                    throw new OhMyPackageException("Value is invalid.");
                }

                if (encoding == null)
                {
                    throw new OhMyPackageException("Encoding is invalid.");
                }
